...
router.post('/expenses', ensureAuthenticated, expenseController.createExpense);
router.post('/expenses/update/:id', ensureAuthenticated, expenseController.updateExpense);
